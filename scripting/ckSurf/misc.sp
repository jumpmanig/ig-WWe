...
public void PrintConsoleInfo(int client)
{
	...
	PrintToConsole(client, "This server is running igSurf v%s - Author: Elzi - Server tickrate: %i", PLUGIN_VERSION, RoundToNearest(fltickrate));
	PrintToConsole(client, "This versionhas been made possible by: jonitaikaponi, nikooo777, connorjan, blackhawk74, ");
	PrintToConsole(client, "zAfLu, Squallkins, marcowmadeira, 2called-chaos, 1DJ, Maxximou5, peace-maker, elzi, sadhands.");
