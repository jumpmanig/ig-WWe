...
public Plugin myinfo = 
{
	name = "igSurf", 
	author = "Sadhands", 
	description = "Imperfect Gamers Surf Timer",  //Dont want to add custom server name on github
...
public void OnPluginStart()
{
	...
	g_hChatPrefix = CreateConVar("ck_chat_prefix", "IG", "Determines the prefix used for chat messages", FCVAR_NOTIFY);
	g_hServerName = CreateConVar("ck_server_name", "Imperfectgamers.org", "Determines the server name displayed in the timer text whilst in the start zone", FCVAR_NOTIFY);
	...
	//client commands
	RegConsoleCmd("sm_usp", Client_Usp, "[IG] spawns a usp silencer");
	RegConsoleCmd("sm_avg", Client_Avg, "[IG] prints in chat the average time of the current map");
	RegConsoleCmd("sm_accept", Client_Accept, "[IG] allows you to accept a challenge request");
	RegConsoleCmd("sm_hidechat", Client_HideChat, "[IG] hides your ingame chat");
	RegConsoleCmd("sm_hideweapon", Client_HideWeapon, "[IG] hides your weapon model");
	RegConsoleCmd("sm_disarm", Client_HideWeapon, "[IG] hides your weapon model");
	RegConsoleCmd("sm_goto", Client_GoTo, "[IG] teleports you to a selected player");
	RegConsoleCmd("sm_sound", Client_QuakeSounds, "[IG] on/off quake sounds");
	RegConsoleCmd("sm_surrender", Client_Surrender, "[IG] surrender your current challenge");
	RegConsoleCmd("sm_bhop", Client_AutoBhop, "[IG] on/off autobhop");
	RegConsoleCmd("sm_help2", Client_RankingSystem, "[IG] Explanation of the ckSurf ranking system");
	RegConsoleCmd("sm_flashlight", Client_Flashlight, "[IG] on/off flashlight");
	RegConsoleCmd("sm_maptop", Client_MapTop, "[IG] displays local map top for a given map");
	RegConsoleCmd("sm_mtop", Client_MapTop, "[IG] displays local map top for a given map");
	RegConsoleCmd("sm_hidespecs", Client_HideSpecs, "[IG] hides spectators from menu/panel");
	RegConsoleCmd("sm_compare", Client_Compare, "[IG] compare your challenge results");
	RegConsoleCmd("sm_wr", Client_Wr, "[IG] prints records in chat");
	RegConsoleCmd("sm_abort", Client_Abort, "[IG] abort your current challenge");
	RegConsoleCmd("sm_spec", Client_Spec, "[IG] chooses a player who you want to spectate and switch you to spectators");
	RegConsoleCmd("sm_watch", Client_Spec, "[IG] chooses a player who you want to spectate and switch you to spectators");
	RegConsoleCmd("sm_spectate", Client_Spec, "[IG] chooses a player who you want to spectate and switch you to spectators");
	RegConsoleCmd("sm_challenge", Client_Challenge, "[IG] allows you to start a race against others");
	RegConsoleCmd("sm_helpmenu", Client_Help, "[IG] help menu which displays all ckSurf commands");
	RegConsoleCmd("sm_help", Client_Help, "[IG] help menu which displays all ckSurf commands");
	RegConsoleCmd("sm_profile", Client_Profile, "[IG] opens a player profile");
	RegConsoleCmd("sm_rank", Client_Profile, "[IG] opens a player profile");
	RegConsoleCmd("sm_options", Client_OptionMenu, "[IG] opens options menu");
	RegConsoleCmd("sm_top", Client_Top, "[IG] displays top rankings (Top 100 Players, Top 50 overall)");
	RegConsoleCmd("sm_t", Client_Top, "[IG] displays top rankings (Top 100 Players, Top 50 overall)");
	RegConsoleCmd("sm_topSurfers", Client_Top, "[IG] displays top rankings (Top 100 Players, Top 50 overall)");
	RegConsoleCmd("sm_bonustop", Client_BonusTop, "[IG] displays top rankings of the bonus");
	RegConsoleCmd("sm_btop", Client_BonusTop, "[IG] displays top rankings of the bonus");
	RegConsoleCmd("sm_stop", Client_Stop, "[IG] stops your timer");
	RegConsoleCmd("sm_ranks", Client_Ranks, "[IG] prints in chat the available player ranks");
	RegConsoleCmd("sm_pause", Client_Pause, "[IG] on/off pause (timer on hold and movement frozen)");
	RegConsoleCmd("sm_showsettings", Client_Showsettings, "[IG] shows ckSurf server settings");
	RegConsoleCmd("sm_latest", Client_Latest, "[IG] shows latest map records");
	RegConsoleCmd("sm_showtime", Client_Showtime, "[IG] on/off - timer text in panel/menu");
	RegConsoleCmd("sm_hide", Client_Hide, "[IG] on/off - hides other players");
	RegConsoleCmd("sm_h", Client_Hide, "[IG] on/off - hides other players");
	RegConsoleCmd("sm_togglecheckpoints", ToggleCheckpoints, "[IG] on/off - Enable player checkpoints");
	RegConsoleCmd("+noclip", NoClip, "[IG] Player noclip on");
	RegConsoleCmd("-noclip", UnNoClip, "[IG] Player noclip off");
	RegConsoleCmd("sm_nc", Command_ckNoClip, "[IG] Player noclip on/off");

	// Teleportation commands
	RegConsoleCmd("sm_stages", Command_SelectStage, "[IG] Opens up the stage selector");
	RegConsoleCmd("sm_r", Command_Restart, "[IG] Teleports player back to the start");
	RegConsoleCmd("sm_restart", Command_Restart, "[IG] Teleports player back to the start");
	RegConsoleCmd("sm_start", Command_Restart, "[IG] Teleports player back to the start");
	RegConsoleCmd("sm_b", Command_ToBonus, "[IG] Teleports player back to the start");
	RegConsoleCmd("sm_ncr", Command_RestartNC, "[IG] Teleports player back to the start after they have NoClipped as well as set state to not noclipd");
	RegConsoleCmd("sm_bonus", Command_ToBonus, "[IG] Teleports player back to the start");
	RegConsoleCmd("sm_bonuses", Command_ListBonuses, "[IG] Displays a list of bonuses in current map");
	RegConsoleCmd("sm_s", Command_ToStage, "[IG] Teleports player to the selected stage");
	RegConsoleCmd("sm_stage", Command_ToStage, "[IG] Teleports player to the selected stage");
	RegConsoleCmd("sm_end", Command_ToEnd, "[IG] Teleports player to the end zone");

	// Titles
	RegConsoleCmd("sm_title", Command_SetTitle, "[IG] Displays player's titles");
	RegConsoleCmd("sm_titles", Command_SetTitle, "[IG] Displays player's titles");

	if (g_hServerVipCommand.BoolValue)
	{
		RegConsoleCmd("sm_vip", Command_Vip, "[IG] VIP's commands and effects");
		RegConsoleCmd("sm_effects", Command_Vip, "[IG] VIP's commands and effects");
		RegConsoleCmd("sm_effect", Command_Vip, "[IG] VIP's commands and effects");
	}

	// MISC
	RegConsoleCmd("sm_tier", Command_Tier, "[IG] Prints information on the current map");
	RegConsoleCmd("sm_maptier", Command_Tier, "[IG] Prints information on the current map");
	RegConsoleCmd("sm_mapinfo", Command_Tier, "[IG] Prints information on the current map");
	RegConsoleCmd("sm_mi", Command_Tier, "[IG] Prints information on the current map");
	RegConsoleCmd("sm_m", Command_Tier, "[IG] Prints information on the current map");
	RegConsoleCmd("sm_difficulty", Command_Tier, "[IG] Prints information on the current map");
	RegConsoleCmd("sm_btier", Command_bTier, "[IG] Prints tier information on current map's bonuses");
	RegConsoleCmd("sm_bonusinfo", Command_bTier, "[IG] Prints tier information on current map's bonuses");
	RegConsoleCmd("sm_bi", Command_bTier, "[IG] Prints tier information on current map's bonuses");
	RegConsoleCmd("sm_howto", Command_HowTo, "[IG] Displays a youtube video on how to surf");
	RegConsoleCmd("sm_ve", Command_VoteExtend, "[IG] Vote to extend the map");
	RegConsoleCmd("sm_vmute", Command_MutePlayer, "[IG] Mute a player");

	// Teleport to the start of the stage
	RegConsoleCmd("sm_stuck", Command_Teleport, "[IG] Teleports player back to the start of the stage");
	RegConsoleCmd("sm_back", Command_Teleport, "[IG] Teleports player back to the start of the stage");
	RegConsoleCmd("sm_rs", Command_Teleport, "[IG] Teleports player back to the start of the stage");
	RegConsoleCmd("sm_play", Command_Teleport, "[IG] Teleports player back to the start");
	RegConsoleCmd("sm_spawn", Command_Teleport, "[IG] Teleports player back to the start");

	// Player Checkpoints
	RegConsoleCmd("sm_teleport", Command_goToPlayerCheckpoint, "[IG] Teleports player to his last checkpoint");
	RegConsoleCmd("sm_tele", Command_goToPlayerCheckpoint, "[IG] Teleports player to his last checkpoint");
	RegConsoleCmd("sm_prac", Command_goToPlayerCheckpoint, "[IG] Teleports player to his last checkpoint");
	RegConsoleCmd("sm_practice", Command_goToPlayerCheckpoint, "[IG] Teleports player to his last checkpoint");

	RegConsoleCmd("sm_cp", Command_createPlayerCheckpoint, "[IG] Creates a checkpoint, where the player can teleport back to");
	RegConsoleCmd("sm_checkpoint", Command_createPlayerCheckpoint, "[IG] Creates a eckpoint, where the player can teleport back to");
	RegConsoleCmd("sm_undo", Command_undoPlayerCheckpoint, "[IG] Undoes the players lchast checkpoint");
	RegConsoleCmd("sm_normal", Command_normalMode, "[IG] Switches player back to normal mode");
	RegConsoleCmd("sm_n", Command_normalMode, "[IG] Switches player back to normal mode");

	RegAdminCmd("sm_ckadmin", Admin_ckPanel, g_AdminMenuFlag, "[IG] Displays the ckSurf menu panel");
	RegAdminCmd("sm_extend", Command_extend, g_AdminMenuFlag, "[IG] Extend map by certain amount");
	RegAdminCmd("sm_refreshprofile", Admin_RefreshProfile, g_AdminMenuFlag, "[IG] Recalculates player profile for given steam id");
	RegAdminCmd("sm_resetchallenges", Admin_DropChallenges, ADMFLAG_ROOT, "[IG] Resets all player challenges (drops table challenges) - requires z flag");
	RegAdminCmd("sm_resettimes", Admin_DropAllMapRecords, ADMFLAG_ROOT, "[IG] Resets all player times (drops table playertimes) - requires z flag");
	RegAdminCmd("sm_resetranks", Admin_DropPlayerRanks, ADMFLAG_ROOT, "[IG] Resets the all player points  (drops table playerrank - requires z flag)");
	RegAdminCmd("sm_resetmaptimes", Admin_ResetMapRecords, ADMFLAG_ROOT, "[IG] Resets player times for given map - requires z flag");
	RegAdminCmd("sm_resetplayerchallenges", Admin_ResetChallenges, ADMFLAG_ROOT, "[IG] Resets (won) challenges for given steamid - requires z flag");
	RegAdminCmd("sm_resetplayertimes", Admin_ResetRecords, ADMFLAG_ROOT, "[IG] Resets pro map times (+extrapoints) for given steamid with or without given map - requires z flag");
	RegAdminCmd("sm_resetplayermaptime", Admin_ResetMapRecord, ADMFLAG_ROOT, "[IG] Resets pro map time for given steamid and map - requires z flag");
	RegAdminCmd("sm_deleteproreplay", Admin_DeleteMapReplay, ADMFLAG_ROOT, "[IG] Deletes pro replay for a given map - requires z flag");
	RegAdminCmd("sm_resetextrapoints", Admin_ResetExtraPoints, ADMFLAG_ROOT, "[IG] Resets given extra points for all players with or without given steamid");
	RegAdminCmd("sm_deletecheckpoints", Admin_DeleteCheckpoints, ADMFLAG_ROOT, "[IG] Reset checkpoints on the current map");
	RegAdminCmd("sm_insertmaptiers", Admin_InsertMapTiers, ADMFLAG_ROOT, "[IG] Insert premade maptier information into the database (ONLY RUN THIS ONCE)");
	RegAdminCmd("sm_insertmapzones", Admin_InsertMapZones, ADMFLAG_ROOT, "[IG] Insert premade map zones into the database (ONLY RUN THIS ONCE)");
	RegAdminCmd("sm_zones", Command_Zones, g_ZoneMenuFlag, "[IG] Opens up the zone creation menu");
	RegAdminCmd("sm_admintitles", Admin_giveTitle, ADMFLAG_ROOT, "[IG] Gives a player a title");
	RegAdminCmd("sm_admintitle", Admin_giveTitle, ADMFLAG_ROOT, "[IG] Gives a player a title");
	RegAdminCmd("sm_givetitle", Admin_giveTitle, ADMFLAG_ROOT, "[IG] Gives a player a title");
	RegAdminCmd("sm_removetitles", Admin_deleteTitles, ADMFLAG_ROOT, "[IG] Removes player's all titles");
	RegAdminCmd("sm_removetitle", Admin_deleteTitle, ADMFLAG_ROOT, "[IG] Removes specific title from a player");

	RegAdminCmd("sm_addmaptier", Admin_insertMapTier, g_AdminMenuFlag, "[IG] Changes maps tier");
	RegAdminCmd("sm_amt", Admin_insertMapTier, g_AdminMenuFlag, "[IG] Changes maps tier");
	RegAdminCmd("sm_addspawn", Admin_insertSpawnLocation, g_AdminMenuFlag, "[IG] Changes the position !r takes players to");
	RegAdminCmd("sm_delspawn", Admin_deleteSpawnLocation, g_AdminMenuFlag, "[IG] Removes custom !r position");
	RegAdminCmd("sm_clearassists", Admin_ClearAssists, g_AdminMenuFlag, "[IG] Clears assist points (map progress) from all players");
